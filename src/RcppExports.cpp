...
RcppExport SEXP _slca_log_add_exp(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _slca_log_sum_exp(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _slca_calcModel(SEXP ySEXP, SEXP nobsSEXP, SEXP nvarSEXP, SEXP nlevSEXP, SEXP parSEXP, SEXP fix0SEXP, SEXP refSEXP, SEXP nlvSEXP, SEXP nrlSEXP, SEXP nlfSEXP, SEXP npiSEXP, SEXP ntauSEXP, SEXP nrhoSEXP, SEXP ulSEXP, SEXP vlSEXP, SEXP lfSEXP, SEXP trSEXP, SEXP rtSEXP, SEXP eqrlSEXP, SEXP eqlfSEXP, SEXP ncSEXP, SEXP nkSEXP, SEXP nlSEXP, SEXP nclSEXP, SEXP nc_piSEXP, SEXP nk_tauSEXP, SEXP nl_tauSEXP, SEXP nc_rhoSEXP, SEXP nr_rhoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// em_est
List em_est(IntegerVector y, int nobs, IntegerVector nvar, IntegerVector nlev, NumericVector par_origin, LogicalVector fix0, int nlv, int nrl, int nlf, int npi, int ntau, int nrho, IntegerVector ul, IntegerVector vl, IntegerVector lf, IntegerVector tr, IntegerVector rt, IntegerVector eqrl, IntegerVector eqlf, IntegerVector nc, IntegerVector nk, IntegerVector nl, IntegerVector ncl, IntegerVector nc_pi, IntegerVector nk_tau, IntegerVector nl_tau, IntegerVector nc_rho, IntegerVector nr_rho, int max_iter, double tol, bool verbose);
RcppExport SEXP _slca_em_est(SEXP ySEXP, SEXP nobsSEXP, SEXP nvarSEXP, SEXP nlevSEXP, SEXP par_originSEXP, SEXP fix0SEXP, SEXP nlvSEXP, SEXP nrlSEXP, SEXP nlfSEXP, SEXP npiSEXP, SEXP ntauSEXP, SEXP nrhoSEXP, SEXP ulSEXP, SEXP vlSEXP, SEXP lfSEXP, SEXP trSEXP, SEXP rtSEXP, SEXP eqrlSEXP, SEXP eqlfSEXP, SEXP ncSEXP, SEXP nkSEXP, SEXP nlSEXP, SEXP nclSEXP, SEXP nc_piSEXP, SEXP nk_tauSEXP, SEXP nl_tauSEXP, SEXP nc_rhoSEXP, SEXP nr_rhoSEXP, SEXP max_iterSEXP, SEXP tolSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type y(ySEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(em_est(y, nobs, nvar, nlev, par_origin, fix0, nlv, nrl, nlf, npi, ntau, nrho, ul, vl, lf, tr, rt, eqrl, eqlf, nc, nk, nl, ncl, nc_pi, nk_tau, nl_tau, nc_rho, nr_rho, max_iter, tol, verbose));
    return rcpp_result_gen;
END_RCPP
}
// fll
double fll(IntegerVector y, NumericVector par, int nobs, IntegerVector nvar, IntegerVector nlev, int nlv, int nrl, int nlf, int npi, int ntau, int nrho, IntegerVector ul, IntegerVector vl, IntegerVector lf, IntegerVector tr, IntegerVector rt, IntegerVector eqrl, IntegerVector eqlf, IntegerVector nc, IntegerVector nk, IntegerVector nl, IntegerVector ncl, IntegerVector nc_pi, IntegerVector nk_tau, IntegerVector nl_tau, IntegerVector nc_rho, IntegerVector nr_rho);
RcppExport SEXP _slca_fll(SEXP ySEXP, SEXP parSEXP, SEXP nobsSEXP, SEXP nvarSEXP, SEXP nlevSEXP, SEXP nlvSEXP, SEXP nrlSEXP, SEXP nlfSEXP, SEXP npiSEXP, SEXP ntauSEXP, SEXP nrhoSEXP, SEXP ulSEXP, SEXP vlSEXP, SEXP lfSEXP, SEXP trSEXP, SEXP rtSEXP, SEXP eqrlSEXP, SEXP eqlfSEXP, SEXP ncSEXP, SEXP nkSEXP, SEXP nlSEXP, SEXP nclSEXP, SEXP nc_piSEXP, SEXP nk_tauSEXP, SEXP nl_tauSEXP, SEXP nc_rhoSEXP, SEXP nr_rhoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type y(ySEXP);
...
RcppExport SEXP _slca_calcfreq(SEXP misSEXP, SEXP nrepSEXP, SEXP nmisSEXP, SEXP freqSEXP, SEXP xobsSEXP, SEXP ncSEXP, SEXP NSEXP, SEXP tolSEXP, SEXP max_iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _slca_simModel(SEXP nobsSEXP, SEXP nvarSEXP, SEXP nlevSEXP, SEXP parSEXP, SEXP nlvSEXP, SEXP nrlSEXP, SEXP nlfSEXP, SEXP npiSEXP, SEXP ntauSEXP, SEXP nrhoSEXP, SEXP ulSEXP, SEXP vlSEXP, SEXP lfSEXP, SEXP rtSEXP, SEXP eqrlSEXP, SEXP eqlfSEXP, SEXP ncSEXP, SEXP nkSEXP, SEXP nlSEXP, SEXP nclSEXP, SEXP nc_piSEXP, SEXP nk_tauSEXP, SEXP nl_tauSEXP, SEXP nc_rhoSEXP, SEXP nr_rhoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type nobs(nobsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_slca_log_add_exp", (DL_FUNC) &_slca_log_add_exp, 2},
    {"_slca_log_sum_exp", (DL_FUNC) &_slca_log_sum_exp, 1},
    {"_slca_calcModel", (DL_FUNC) &_slca_calcModel, 29},
    {"_slca_em_est", (DL_FUNC) &_slca_em_est, 31},
    {"_slca_fll", (DL_FUNC) &_slca_fll, 27},
    {"_slca_calcfreq", (DL_FUNC) &_slca_calcfreq, 9},
    {"_slca_simModel", (DL_FUNC) &_slca_simModel, 25},
    {NULL, NULL, 0}
};

RcppExport void R_init_slca(DllInfo *dll) {
